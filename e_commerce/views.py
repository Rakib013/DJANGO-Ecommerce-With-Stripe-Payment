    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    return redirect('e_commerce:payment', payment_option='stripe')
                elif payment_option == 'P':
                    return redirect('e_commerce:payment', payment_option='paypal')
                else:
                    messages.warning(
            ...
            return redirect("e_commerce:order-summary")
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            return redirect("e_commerce:product", slug=slug)
    else:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("e_commerce:request-refund")
...
class ItemCategory(ListView):
    ...
    def get_conext_data(self, **kwargs):
        ...
        context['category_items'] = self.get_queryset()
        return context
...
class UserRegister(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            user.save()
            login(request, user)
            messages.success(request, "Sign Up successfully completed!")
